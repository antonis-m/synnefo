...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OvsVlanPoolTable'
        db.create_table('db_ovsvlanpooltable', (
        ...
        db.send_create_signal('db', ['OvsVlanPoolTable'])

        # Adding field 'Network.ovs_vlan'
        db.add_column('db_network', 'ovs_vlan',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OvsVlanPoolTable'
        db.delete_table('db_ovsvlanpooltable')

        # Deleting field 'Network.ovs_vlan'
        db.delete_column('db_network', 'ovs_vlan')
    ...
    models = {
        ...
        'db.network': {
            ...
            'ovs_vlan': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
            'project': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
        ...
        'db.ovsvlanpooltable': {
            'Meta': {'object_name': 'OvsVlanPoolTable'},
            'available_map': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'base': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offset': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
